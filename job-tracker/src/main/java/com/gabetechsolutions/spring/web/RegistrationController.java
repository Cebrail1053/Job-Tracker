...
public class RegistrationController {
    ...
    public RegistrationResponse register(@RequestBody RegistrationRequest request) {
        ...
        return user.map(value -> new RegistrationResponse("User registered successfully", value.getEmail()))
              .orElseGet(() -> new RegistrationResponse("User registration failed", request.email()));
    }
}
